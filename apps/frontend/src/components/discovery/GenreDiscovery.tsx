...
export function GenreDiscovery({ genre, filters = {} }: GenreDiscoveryProps) {
    const {
        data,
        fetchNextPage,
        hasNextPage,
        ...
        queryKey: ["discover", "genre", genre, filters],
        queryFn: ({ pageParam }) =>
            services.discovery.getByGenre(genre, {
                ...filters,
                cursor: pageParam,
                page_size: 20,
            }),
        ...
        return (
            <div className="animate-in fade-in duration-300">
                <EmptyState
                    ...
                    description={`Could not load ${genre} stories.`}
                    action={
    ...
    if (filteredStories.length === 0) {
        return (
            <div className="animate-in fade-in duration-300">
                <EmptyState
                    title={`No ${genre} stories found`}
                    description="Check back soon for more stories in this genre."
                />
            </div>
        );
    }
