...
export function TrendingFeed({ filters = {} }: TrendingFeedProps) {
    const {
        data,
        fetchNextPage,
        hasNextPage,
        ...
        queryKey: ["discover", "trending", filters],
        queryFn: ({ pageParam }) =>
            services.discovery.getTrending({
                ...filters,
                cursor: pageParam,
                page_size: 20,
            }),
        ...
        return (
            <div className="animate-in fade-in duration-300">
                <EmptyState
                    ...
                    description="Could not load trending stories."
                    action={
        ...
        return (
            <div className="animate-in fade-in duration-300">
                <EmptyState
                    ...
                    description="Check back soon for trending content."
                />
            </div>
        );
    }
