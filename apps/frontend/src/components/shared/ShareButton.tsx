...
export default function ShareButton({
    ...
    const handleNativeShare = async () => {
        ...
        // If native share fails or is cancelled, the dropdown stays open
        // so users can choose another option
    };
    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-48">
                ...
                <DropdownMenuItem onClick={() => copyToClipboard(shareOptions.url)}>
                ...
                <DropdownMenuItem onClick={() => shareToReddit(shareOptions)}>
                    <svg
